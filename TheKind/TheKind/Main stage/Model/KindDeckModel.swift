...
enum KindDecksFields: String {
    case userdeckFieldName = "userKindDeck", mainkindFieldName = "userMainKind"
}


class GameKinds {
    
    static func createKindCard(id: Int) -> KindCard? {
        var kindcard: KindCard
        if let kindIdEnum = KindCardIdEnum(rawValue: id) {
    ...
    static func createKindCardDeck(ids: [Int]) -> [KindCard] {
    ...
    static let kindsForDriver: [String: [KindCard]] = [DriversEnum.intellect.rawValue: intellectCardsArray,
                                                            DriversEnum.imagination.rawValue: imaginationCardsArray,
                                                            DriversEnum.intuition.rawValue: intuitionCardsArray,
                                                            DriversEnum.empathy.rawValue: EmpathyCardsArray]
    
    static let intellectCardsArray: [KindCard] = Array(intellectCards.values)
    static let intellectCards: [KindCardIdEnum: KindCard] = [.explorer : KindCard(kindId: .explorer, antagonists: nil, kindName: .explorer, iconImageName: .explorer),
    ...
    static let intuitionCards: [KindCardIdEnum: KindCard] = [.leader : KindCard(kindId: .leader, antagonists: nil, kindName: .leader, iconImageName: .leader),
    ...
    static let EmpathyCards: [KindCardIdEnum: KindCard] = [.angel : KindCard(kindId: .angel, antagonists: nil, kindName: .angel, iconImageName: .angel),
    ...
    static let imaginationCards: [KindCardIdEnum: KindCard] = [.visionary : KindCard(kindId: .visionary, antagonists: nil, kindName: .visionary, iconImageName: .visionary),
    ...
    static let twelveKindsOriginal: [KindCardIdEnum: KindCard] = [.explorer : KindCard(kindId: .explorer, antagonists: nil, kindName: .explorer, iconImageName: .explorer),
                                                  .mentor : KindCard(kindId: .mentor, antagonists: nil, kindName: .mentor, iconImageName: .mentor),
                                                  .rebel : KindCard(kindId: .rebel, antagonists: nil, kindName: .rebel, iconImageName: .rebel),
    ...
    static let minorKindsOriginal: [KindCardIdEnum: KindCard] = [.achiever : KindCard(kindId: .achiever, antagonists: nil, kindName: .achiever, iconImageName: .achiever),
